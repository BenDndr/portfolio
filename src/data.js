const data = [
  {
    ...
    "imgurl": require("./img/DareToGo.png").default,
  ...
  {
    "id": 4,
    "url": "https://test-embershop.herokuapp.com/",
    "imgurl": require("./img/EmberShop.png").default,
    "name": "EmberShop",
    "description": "Projet simulant un petit site e-commerce. J'ai réalisé ce projet afin de m'essayer au framework EmberJs. Réalisé avec le framework JavaScript Emberjs et déployé sur Heroku."
  },
  {
    "id": 5,
    "url": "https://bendndr.com/DrumJs/",
    "imgurl": require("./img/DrumJs.png").default,
    "name": "Drumjs",
    "description": "Petit projet pour améliorer ma maîtrise du JS et du DOM. DrumJs est un simulateur de sons de batterie jouable au clavier. La page a été développée avec HTML5, CSS, JavaScript et déployée sur GitHub Pages. "
  },
  {
    "id": 6,
